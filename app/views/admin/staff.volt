                ...
                <div class="w-box-content cnt_a">
                    ...
                    {% for s in staff %}
                        <tr>
                            ...
                            <td>{{ s.lastname }}</td>
                            <td>{{ s.middlename }}</td>
                            <td>{{ s.getUser().email }}</td>
                            <td>{{ s.mobile }}</td>
                            <td>{{ s.contactAddress }}</td>
                            <td>
                                {% if s.getUser().active == 1 %}
                                <span class="badge badge-success">active</span>
                                {% else %}
                                <span class="badge badge-warning">inactive</span>
                                {% endif %}
                            </td>
                            <td><a href="javascript:" onclick="edit('{{ s.id }}', '{{ s.getUser().active }}')" class="btn btn-mini" ><i class="icon icon-edit"></i> Edit</a></td>
                        </tr>
