<div class="container">
    ...
    <div class="row-fluid">
        ...
        <div class="span2">
            <div class="sidebar">
                <ul id="pageNav">
                    <li class="current"><a href="/OnlineAdmission/admin/index">Dashboard</a></li>
        ...
        <script type="text/javascript" charset="utf-8">
            $().ready(function() {
                var elf = $('#elfinder').elfinder({
                    url : '/OnlineAdmission/elfinder/php/connector.php'  // connector URL (REQUIRED)
        ...
        <div class="span10">
            <h3 class="heading_a">File Management</h3>
