...
<div class="container">
    ...
    <div class="row-fluid">
        ...
        <div class="span10">
            ...
            <h2 class="heading_a">{{ m.subject | capitalize}}</h2>
            <p><span class="muted">FROM:</span> {{ m.sender }}</p>
            ...
            <div class="span12">
                ...
                <form id="reply" action="../replyMessage" method="post">
                    <input type="hidden" name="hd_subject" id="hd_subject" value="{{ m.subject }}">
                    <input type="hidden" id="hd_receiver" name="hd_receiver" value="{{ m.receiver }}">
