<div class="container">
    ...
    <div class="row-fluid">
        ...
        <div class="span10">
            <div class="w-box">
                <div class="w-box-header">EDIT APPLICATION #<?php echo $id; ?>
                <div class="pull-right">
                        ...
                        <div class="tab-content">
                                ...
                                <p class="heading_a">Personal Details</p>
                                    <div class="span5">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="firstname" id="firstname" value="<?php echo $app->getApplicant()->firstname; ?>" class="span10 req">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="lastname" value="<?php echo $app->getApplicant()->lastname; ?>" id="lastname" class="span10 req">
                                                <span class="help-block inline">Must be at least 3 characters</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="formSep control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="middlename" value="<?php echo $app->getApplicant()->middlename; ?>" id="middlename" class="span10 req">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="dob" value="<?php echo $app->getApplicant()->dob; ?>" id="dob" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" class="span10">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="pob" id="pob" value="<?php echo $app->getApplicant()->pob; ?>" class="span10">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="<?php echo $app->getApplicant()->nationality; ?>" name="nationality" id="nationality" class="span10">
                                                <span class="help-block">Cannot be blank</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="father" id="father" value="<?php echo $app->getApplicant()->father; ?>" class="span10">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="mother" id="mother" value="<?php echo $app->getApplicant()->mother; ?>" class="span10">
                                                <span class="help-block">At least 5 characters</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="span5">
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" name="address" id="address" class="span10" rows="3">
                                                    <?php echo $app->getApplicant()->contactAddress; ?>
                                                </textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="tel" name="tel" value="<?php echo $app->getApplicant()->telephone; ?>" id="tel" class="span10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="tel" name="mobile" value="<?php echo $app->getApplicant()->mobile; ?>" id="mobile" class="span10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="<?php echo $app->getApplicant()->passportNumber; ?>" name="passport" id="passport" class="span10">
                                                <span class="help-block">Cannot be blank</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="<?php echo $app->getApplicant()->passprtPlace; ?>" name="place" id="place" class="span10">
                                                <span class="help-block">Cannot be blank</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="<?php echo $app->getApplicant()->passportDate; ?>" name="issue" data-date-format="yyyy-mm-dd" id="issue" placeholder="yyyy-mm-dd" class="span10">
                                                <span class="help-block">Cannot be blank</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="formSep control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="<?php echo $app->getApplicant()->passportExpiry; ?>" name="expiry" id="expiry" placeholder="yyyy-mm-dd"
                            ...
                            <div id="academic" class="tab-pane">
                                ...
                                <div class="formSep control-group row-fluid">
                                    <div class="span6">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="<?php echo $app->getAcademic()->school; ?>" name="school" id="school" class="span10">
                                        </div>
                                    </div>
                                    <div class="span6">
                                        <label for="field" class="control-label ">Field of Study</label>
                                        <div class="controls">
                                            <input type="text" value="<?php echo $app->getAcademic()->field; ?>" name="field" id="field" class="span10">
                                        </div>
                                    </div>
                                ...
                                <div class="formSep control-group row-fluid">
                                    ...
                                    <div class="span6">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="<?php echo $app->getAcademic()->degree; ?>" name="degree" id="degree" class="span10">
                                        </div>
                                    </div>
                                    ...
                                    <div class="span6">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="<?php echo $app->getAcademic()->year; ?>" name="year" id="year" class="span10">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="english" class="tab-pane">
                                ...
                                <table class="table">
                                    ...
                                    <?php foreach ($app->getEnglish() as $e) { ?>
                                        <tr>
                                            <td><?php echo Phalcon\Text::upper($e->name); ?></td>
                                            <td><?php echo $e->score; ?></td>
                                            <td><?php echo $e->date; ?></td>
                                            <td><a href="javascript:removeEnglish('<?php echo $e->id; ?>')" class="btn btn-mini"><i class="splashy-document_letter_remove"></i> Delete</a></td>
                                        </tr>
                                    <?php } ?>
                                </table>
                            ...
                            <div id="documents" class="tab-pane">
                                ...
                                <table id="files" class="table">
                                    ...
                                    <?php foreach ($app->getFile() as $f) { ?>
                                        <!---Hidden Div for showing files--->
                                        <div style="display: none;">
                                            <a id="<?php echo $f->id; ?>" href="/OnlineAdmission/<?php echo $f->link; ?>" data-ob="lightbox"></a>
                                        </div>
                                        <!---end of hidden stuff--->
                                        <tr id="<?php echo $f->id; ?>">
                                            <td><?php echo $f->filename; ?></td>
                                            <td><?php echo $f->dateUploaded; ?></td>
                                            <td><?php echo $f->size; ?> bytes</td>
                                            <td><a href="#documents" onclick="_('<?php echo $f->id; ?>')" class="btn btn-mini"><i class="splashy-zoom_in"></i> View</a>
                                                 <a class="btn btn-mini" href="javascript:fileRemove('<?php echo $f->id; ?>', '<?php echo $app->id; ?>');"><i class="splashy-document_letter_remove"></i> Delete</a></td>
                                        </tr>
                                    <?php } ?>
