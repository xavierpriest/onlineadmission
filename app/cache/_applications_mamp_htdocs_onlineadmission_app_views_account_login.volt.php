<?php echo $this->assets->outputCss('extras'); ?>
...
<div id="login-wrapper" class="clearfix">
    ...
    <div class="main-col">
        ...
        <div class="panel">
            ...
            <form id="login-validate" action="<?php echo $this->url->get('account/doLogin'); ?>" method="post">
        ...
        <div class="panel" style="display:none">
            ...
            <form id="forgot-validate" method="post" action="<?php echo $this->url->get('account/doRemember'); ?>">
