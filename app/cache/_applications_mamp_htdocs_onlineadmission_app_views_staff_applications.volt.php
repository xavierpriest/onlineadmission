            ...
            <div class="sidebar">
                <ul id="pageNav">
                    ...
                    <li><a href="../staff/applications">Applications
                            <span class="pull-right badge badge-info"><?php echo $countNew; ?> new</span>
                        </a></li>
        ...
        <div class="span10">
            <div class="w-box w-box-green">
                ...
                <div class="w-box-content">
                            ...
                            <?php $v69909533294549550481iterator = $apps; $v69909533294549550481incr = 0; $v69909533294549550481loop = new stdClass(); $v69909533294549550481loop->length = count($v69909533294549550481iterator); $v69909533294549550481loop->index = 1; $v69909533294549550481loop->index0 = 1; $v69909533294549550481loop->revindex = $v69909533294549550481loop->length; $v69909533294549550481loop->revindex0 = $v69909533294549550481loop->length - 1; ?><?php foreach ($v69909533294549550481iterator as $a) { ?><?php $v69909533294549550481loop->first = ($v69909533294549550481incr == 0); $v69909533294549550481loop->index = $v69909533294549550481incr + 1; $v69909533294549550481loop->index0 = $v69909533294549550481incr; $v69909533294549550481loop->revindex = $v69909533294549550481loop->length - $v69909533294549550481incr; $v69909533294549550481loop->revindex0 = $v69909533294549550481loop->length - ($v69909533294549550481incr + 1); $v69909533294549550481loop->last = ($v69909533294549550481incr == ($v69909533294549550481loop->length - 1)); ?>
                                <?php if ($v69909533294549550481loop->first) { ?>
                                    <thead>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <div class="btn-group">
                                <a href="javascript:details('<?php echo $a->id; ?>');" class="btn btn-mini" title="View"><i class="icon-eye-open"></i></a>
                                <a href="javascript:update('<?php echo $a->id; ?>');" class="btn btn-mini" title="Update Status"><i class="icon-check"></i></a>
                            </div>
                        </td>
                        <td><span class="<?php echo $a->getStatus()->class; ?>"><?php echo $a->getStatus()->name; ?></span></td>
                        <td><?php echo $a->getApplicant()->firstname; ?></td>
                        <td><?php echo $a->getApplicant()->lastname; ?></td>
                        <td><?php echo $a->getApplicant()->middlename; ?></td>
                        <td><?php echo $a->getDepartment()->name; ?></td>
                        <td><?php echo $a->semester; ?></td>
                        <td><?php echo $a->degree; ?></td>
                        <td><?php echo $a->getApplicant()->residenceCountry; ?></td>
                    </tr>
                    <?php $v69909533294549550481incr++; } ?>
