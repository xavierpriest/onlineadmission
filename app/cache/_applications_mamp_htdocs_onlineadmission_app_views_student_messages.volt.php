...
<div class="container">
    ...
    <div id="flash"><?php echo $this->flash->output(); ?></div>
    ...
    <div class="row-fluid">
        ...
        <div class="span2">
            <div class="sidebar">
                ...
                <ul id="pageNav">
                   <li><a href="../student"><i class="icon icon-home"></i> Home</a></li>
                </ul>
                </div>
                    </div>
            ...
            <div class="w-box">
                ...
                <ul id="pageNav">
                    ...
                    <li><a href="../student/messages" id="inbox"><i class="icon icon-envelope"></i> Inbox
                    ...
                    <li><a onclick="doTrash();"  id="trash"><i class="icon icon-trash"></i> Trash
                            <span class="badge badge-important pull-right">
                                  <?php
                    $m = Message::find("status = 'trash' AND receiver = '$my_email'");
                    if(count($m)==0)
                    {
                        echo 0;
                    }else{echo count($m);}
     ...
     <form id="messages">
             ...
             <div class="modal-header">
              ...
              <div class="modal-body">
                <form id="send_message" name="sending_message">
                    ...
                    <textarea id="message" class="span10"></textarea><br>
         ...
         <div id="trash_form" class="span10">
            <h3>Trash</h3>
             <div class="span12">
                 <?php
                  $msgs = Message::find("status = 'trash' AND receiver = '$my_email'");
                    if(count($msgs)==0)
                    {
